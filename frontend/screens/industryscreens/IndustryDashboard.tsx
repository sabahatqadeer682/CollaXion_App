...
// import { CXbotFloatingButton } from "./AIChatbotScreen";
...
//   { icon:"calendar-outline", label:"My\nEvents", screen:"EventsManage", grad:["#193648","#0D2137"] }
...
//     { screen:"MyPosts", icon:"newspaper", label:"My Posts", ac:"#D97706" },
//     { screen:"EventsManage", label:"My Events" }
//   ];
...
//       <Drawer.Screen name="EventsManage"
...
import { AIChatbotScreen, CXbotFloatingButton } from "./AIChatbotScreen"; // ← UPDATED
import { InternshipsMainScreen, PostNewInternshipScreen } from "./InternshipScreens";
import { ChatScreen, MessagesScreen } from "./MessageScreens";
import { CreateMoUScreen, MoUScreen, MouDetailScreen } from "./MouScreens";
import { PostNewProjectScreen, ManageProjectsScreen } from "./ProjectScreens";
...
function DashboardScreen() {
  ...
  const QUICK_ACTIONS = [
    ...
    { icon:"document-text", label:"MOU\nManagement",      screen:"MoUs",                grad:["#0891B2","#0E7490"] as const },
    { icon:"sparkles",      label:"AI\nRecommend",        screen:"AIRecommend",         grad:["#D97706","#B45309"] as const },
    { icon:"calendar-outline", label:"My\nEvents",        screen:"EventsManage",        grad:["#193648","#0D2137"] as const },
  ];
  ...
  return (
    ...
    <View style={{ flex:1, backgroundColor:"#F0F4F8" }}>
      ...
      {/* ── CXbot Floating Button ── YAHAN HAI ── */}
      <CXbotFloatingButton />
...
function CustomDrawer(props: any) {
  ...
  const ITEMS = [
    ...
    { screen:"Profile",            icon:"person-circle",  label:"My Profile",       ac:"#BE185D" },
    { screen:"MyPosts",            icon:"newspaper",      label:"My Posts",         ac:"#D97706" },
    { screen:"EventsManage",       icon:"calendar-outline", label:"My Events",      ac:"#193648" },
  ];
